<?php
    ...
    $ordersColumnNames = array('order_id', 'customer_id', 'destination_address', 'destination_city', 'destination_province','destination_country','destination_zip','quote_discount','payment_method');//global variable for functions that contains the name of all columns in the table
    $ordersInputColumnArray = array('customer_id', 'destination_address', 'destination_city', 'destination_province','destination_country','destination_zip','quote_discount','payment_method'); //used specifically for inserts and updates, it omits the id from above
    ...
    function insertOrder($customer_id, string $destination_address, string $destination_city, string $destination_province, string $destination_country, string $destination_zip, $quote_discount, $payment_method){
        $inputDataArray = array($customer_id, $destination_address, $destination_city, $destination_province, $destination_country, $destination_zip, $quote_discount, $payment_method);
    ...
    function updateOrderOnID(string $id, $customer_id, string $destination_address, string $destination_city, string $destination_province, string $destination_country, string $destination_zip, $quote_discount, $payment_method){
        $inputDataArray = array($customer_id, $destination_address, $destination_city, $destination_province, $destination_country, $destination_zip, $quote_discount, $payment_method);
