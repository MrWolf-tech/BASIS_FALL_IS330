...
<body> <!-- END TAG IN footer.php-->
    ...
    <div class="Navbar">
        <nav>
            <ul id="nav-container">
                <li class="nav-item" title="Home" style="float:right" href="index.php"><a><img src="menupics/home.jpg" alt="HOME" title="Home"/></a></li>
                <li class="nav-item" title="Account" style="float:right" href="loginpage.php"><a><img src="menupics/myspace.jpg" alt="Account" title="Account" /></a></li>
